package pl.altkom.springcloud.lab05.configserver.employeeservice.service;
...
import pl.altkom.springcloud.lab05.configserver.employeeservice.controller.mapper.RequestMapper;
import pl.altkom.springcloud.lab05.configserver.employeeservice.controller.mapper.ResponseMapper;
...
import pl.altkom.springcloud.lab05.configserver.employeeservice.repository.EmployeeRepository;
...
public class EmployeeService {
    ...
    public Employee getEmployee(final Long employeeId) {
        final pl.altkom.springcloud.lab05.configserver.employeeservice.repository.model.Employee employee = employeeRepository
                .findById(employeeId)
    ...
    public Employee createEmployee(final CreateEmployeeRequest request) {
        final pl.altkom.springcloud.lab05.configserver.employeeservice.repository.model.Employee savedEmployee = employeeRepository
    ...
    public Employee modifyEmployee(final Long employeeId, final UpdateEmployeeRequest request) {
        ...
        final pl.altkom.springcloud.lab05.configserver.employeeservice.repository.model.Employee sourceEmployee = employeeRepository
                .findById(employeeId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));

        final pl.altkom.springcloud.lab05.configserver.employeeservice.repository.model.Employee modifiedEmployee = employeeRepository
